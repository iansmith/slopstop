...
SKILLS=(start plan update document archive pr merge doc-sync create-gh gh-init update-ticket grill design tickets single-ticket focus run review investigate red-tests mutation-check adversary implement slop-check vacuity-check complexity-check)
