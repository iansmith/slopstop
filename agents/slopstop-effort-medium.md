---
name: slopstop-effort-medium
description: slopstop worker carrier at medium reasoning effort. Not for model selection — the orchestrator passes `model` on the Agent() call and this file only fixes effort. Never invoked directly; :run selects it from the resolved tier.
effort: medium
---
